...
public:
  ...
  // getters
  inline stamp_t get_timestamp() const {return timestamp;}
  inline se3_t get_transform() const {return transform;}
  inline so3_t get_rotation() const {return transform.so3();}
  inline vector3_t get_translation() const {return transform.translation();}
  inline vector3_t get_linear_velocity() const {return linear_velocity;}
  inline vector3_t get_angular_bias() const {return angular_bias;}
  inline vector3_t get_linear_bias() const {return linear_bias;}
  inline vector3_t get_gravity() const {return gravity;}
  inline vector3_t get_imu_acceleration() const {return imu_acceleration;}
  inline vector3_t get_imu_angular_velocity() const {return imu_angular_velocity;}
  inline matrix18_t get_covariance() const {return covariance;}
  inline vector18_t to_vector() const
  {
  ...
  // setters
  inline void set_timestamp(const stamp_t stamp) {timestamp = stamp;}
  inline void set_transform(const se3_t& transform) {this->transform = transform;}
  inline void set_rotation(const so3_t& rotation) {this->transform.so3() = rotation;}
  inline void set_translation(const vector3_t& translation) {this->transform.translation() = translation;}
  inline void set_linear_velocity(const vector3_t& linear_velocity) {this->linear_velocity = linear_velocity;}
  inline void set_angular_bias(const vector3_t& angular_bias) {this->angular_bias = angular_bias;}
  inline void set_linear_bias(const vector3_t& linear_bias) {this->linear_bias = linear_bias;}
  inline void set_gravity(const vector3_t& gravity) {this->gravity = gravity;}
  inline void set_imu_acceleration(const vector3_t& imu_acceleration) {this->imu_acceleration = imu_acceleration;}
  inline void set_imu_angular_velocity(const vector3_t& imu_angular_velocity) {this->imu_angular_velocity = imu_angular_velocity;}
  inline void set_covariance(const matrix18_t& covariance) {this->covariance = covariance;}
